...
appropriate, fair corrective action in response to any behavior deemed inappropriate,
...
project maintainers at <!-- TODO: add a maintainer contact email once one exists -->
`YOUR_CONDUCT_CONTACT_EMAIL`. All complaints will be reviewed and investigated promptly and
fairly.
